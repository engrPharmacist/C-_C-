...
namespace Tomo
{
	GameOverDenerwujeState::GameOverDenerwujeState(GameDataRef data, int score1, int score2) : _data(data), _score1(score1), _score2(score2)
	{

	}

	void GameOverDenerwujeState::Init()
	{
		//odczyt z pliku//----------------------------------------------------------------------------------------------------------------
		string nick1, nick2;
		string linia;
		...
		PlayButton.setTexture(this->_data->assets.GetTexture("Play Tricky Button"));
	...
	void GameOverDenerwujeState::HandleInput()
	{
		sf::Event event;
	...
	void GameOverDenerwujeState::Update(float dt)
	{
		
	}

	void GameOverDenerwujeState::Draw(float dt)
	{
	...
	int GameOverDenerwujeState::Winer(int a, int b)
	{
		if (a > b)
		{
			return 0;
	...
	void GameOverDenerwujeState::WynikUpdate()
	{
